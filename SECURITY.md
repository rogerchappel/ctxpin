...
Replace this section with the supported versions for `ctxpin`.
...
Do not imply paid support, guaranteed response times, guaranteed fixes, or service-level agreements unless `ctxpin` explicitly provides them.

## Scope

In scope:

- Vulnerabilities in ctxpin.
